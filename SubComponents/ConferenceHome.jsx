...
const ConferenceHome = () => {
  ...
  // Fetch programs data from the Flask backend
  useEffect(() => {
  ...
  return (
    <div>
        ...
        <div className="banner">
          <h1>June 2023</h1>
          <p>
            Join us for an enriching program designed for church workers, 
            where inspiration, growth, and collaboration come together to strengthen our faith and service.
          </p>
